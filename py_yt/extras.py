...
class Video:
    ...
    async def get(
        ...
        """
        async with VideoCore(video_link, None, result_mode, timeout, get_upload_date) as video:
            if get_upload_date:
    ...
    async def getInfo(
        ...
        """
        async with VideoCore(video_link, "getInfo", result_mode, timeout, True) as video:
            await video.async_html_create()
    ...
    async def getFormats(
        ...
        """
        async with VideoCore(video_link, "getFormats", result_mode, timeout, False) as video:
            await video.async_create()
            return video.result
...
class Suggestions:
    ...
    async def get(
        ...
        """
        async with SuggestionsCore(language=language, region=region) as suggestionsInternal:
...
class Transcript:
    ...
    async def get(videoLink: str, params: str = None):
        async with TranscriptCore(videoLink, params) as transcript_core:
